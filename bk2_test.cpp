...
//	cout<<"tmp    "<<endl;
//	print_arr(tmp->sets_ele,tmp->size);
	struct sets_info * tmp2 = set_div_set(p,connect_eles[tmp->sets_ele[0]]);
	free(tmp);tmp = NULL;	
//	cout<<"tmp2    "<<endl;
//	print_arr(tmp2->sets_ele,tmp2->size);
	int i;
...
//print_arr(r->sets_ele,r->size);	
//cout<<"pppp@ "<<i<<v<<endl;
//print_arr(p->sets_ele,p->size);	
//cout<<"xxxx@ "<<i<<v<<endl;
//print_arr(x->sets_ele,x->size);		
		struct sets_info * r_v;
		struct sets_info * p__nv;
		struct sets_info * x__nv;
		r_v = set_union_ele_new(r,v);
//cout<<"r_vr_v@ "<<i<<v<<endl;
//print_arr(r_v->sets_ele,r_v->size);		
